...
export function FloatingContactButton({
  ...
  return (
    <a
      ...
      className="fixed bottom-[calc(1.5rem+var(--cookie-safe,0px))] right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-[transform,bottom] hover:scale-105 print:hidden"
