...
export function CookieConsentBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white px-6 py-4 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] print:hidden dark:border-slate-800 dark:bg-slate-900">
